#  API: Создание корпорации

**Тип:** API  
**Метод:** `POST /create_corporation`  
**Дата:** 20.03.2026
...
Тестирование метода создания корпорации: валидация запроса, проверка статус-кодов, структуры ответа и бизнес-логики.
...
- Коллекция Postman: [Скачать JSON](./Проект.postman_collection.json), перейти в "Corporation" 
